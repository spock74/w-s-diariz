...
def speech_to_text(video_file_path, selected_source_lang, whisper_model, num_speakers):
    ...
    try:
        ...
        video_file_path = "/Users/moraes/Documents/projetos/in_w/inw/using-H_FACE-12-fev-2023/pyannote-speaker-diarization/1.wav"
...
memory = psutil.virtual_memory()
selected_source_lang = gr.Dropdown(choices=source_language_list, type="value", value="en", label="Lingua", interactive=True)
selected_whisper_model = gr.Dropdown(choices=whisper_models, type="value", value="base", label="Selecione o Modelo Whisper", interactive=True)
number_speakers = gr.Number(precision=0, value=2, label="Selecione o numero de falantes", interactive=True)
